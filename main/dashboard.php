...
<body class="bg-gray-200 m-0 p-0 flex flex-col min-h-screen">
    ...
    <div class="container mx-auto w-4/5 my-8 flex-grow">
        <h1 class="text-2xl font-bold text-center mb-4"><i class="fa-solid fa-clipboard text-[#1DA1F2]"></i> Dashboard</h1>
        <div class="flex justify-between items-center space-x-4 mb-4 text-xs md:text-base">
            <a href="../index.php" class="text-white bg-[#1DA1F2] px-4 py-2 rounded transition-colors duration-300 hover:bg-[#0d8ae6]"><i class="fa-solid fa-chevron-left"></i> ‎ Back to Home</a>
            <a href="news_upload.php" class="text-white bg-[#1DA1F2] px-4 py-2 rounded transition-colors duration-300 hover:bg-[#0d8ae6]"><i class="fa-solid fa-upload"></i> ‎ Upload News</a>
        </div>
                    ...
                    <?php while ($row = $result->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td class="whitespace-nowrap p-4 flex gap-2">
                                <a href="news_edit.php?id=<?php echo $row['id']; ?>" class="inline-block rounded bg-green-400 px-4 py-2 transition-colors duration-300 text-xs font-medium text-white hover:bg-green-500"><i class="fa-solid fa-pen-to-square"></i></a>
                                <button onclick="confirmation(<?php echo $row['id']; ?>)" class="inline-block rounded bg-red-600 px-4 py-2 transition-colors duration-300 text-xs font-medium text-white hover:bg-red-700"><i class="fa-solid fa-trash"></i></button>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
