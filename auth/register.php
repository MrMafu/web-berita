...
<body class="bg-gray-200 m-0 p-0 flex items-center justify-center h-screen">
    <div class="w-full max-w-lg mx-auto bg-white p-7.5 rounded-lg shadow transition-shadow duration-300 hover:shadow-lg p-5">
        ...
        <form class="flex flex-col" action="../controller/control.php" method="post">
            ...
            <button class="border-none mt-4 rounded bg-[#1DA1F2] text-white cursor-pointer p-2.5 mb-2.5 transition-colors duration-300 hover:bg-[#0d8ae6] text-sm" type="submit" name="action" value="register">Register</button>
            <h4 class="text-sm">Already have an account? <a class="text-[#1DA1F2] no-underline transition-colors duration-300 hover:text-blue-700" href="login.php">Login</a></h4>
        </form>
